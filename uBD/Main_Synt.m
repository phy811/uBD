...
% fname : 'MSE_Synthetic_geo_R30000_m20_nPts50.mat' or 'MSE_Synthetic_zipf_R30000_m20_nPts50.mat'
%==========================================================================

fname = 'MSE_Synthetic_geo_R30000_m20_nPts50.mat';
D = load(fname, ...
     'epsRange','nPts', ...
...
for sFig = 1:4
    ...
    if sFig == 1
        ...
        if contains(fname, '_zipf_')
            axisSettings = struct( ...
            'ylim', {[-5e-3, 10e-2], [0, 90e-5], [2e-5, 10e-5]}, ...
            'exp',  {-3, -5, -5} ...
            );
            ZoomCfg(1) = struct('pos', [0.5 0.5 0.36 0.36], ...
                'x', [0.8 1.2], 'y', [1e-3  5e-3]);
            ZoomCfg(2) = struct('pos', [0.5 0.5 0.36 0.36], ...
                'x', [3.8 4.2], 'y', [5e-5  10e-5]);
            ZoomCfg(3) = struct('pos', [0.5 0.5 0.36 0.36], ...
                'x', [6.8 7.2], 'y', [2.5e-5  4e-5]);

        else
            axisSettings = struct( ...
                'ylim', {[-5e-3  70e-3], [0  12e-4], [0, 10e-4]}, ... 
                'exp',  {-3, -4, -4} ...
            );
            ZoomCfg(1) = struct('pos', [0.5 0.5 0.36 0.36], ...
                'x', [0.8 1.2], 'y', [2e-3  6e-3]);
            ZoomCfg(2) = struct('pos', [0.5 0.5 0.36 0.36], ...
                'x', [3.8 4.2], 'y', [0.5e-4  1e-4]);
            ZoomCfg(3) = struct('pos', [0.5 0.25 0.36 0.36], ...
                'x', [6.8 7.2], 'y', [0  1e-4]);
        end
